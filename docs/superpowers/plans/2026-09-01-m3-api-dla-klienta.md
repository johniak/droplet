...
- Obowiązują Global Constraints z M0–M2.
...
### Task 5: Skrypt smoke e2e + kryteria M3

**Files:**
- Create: `scripts/smoke.sh`

**Interfaces:**
- Produces: skrypt weryfikujący pełną pętlę na żywym serwerze (kryterium M3: curl z przerwaniem i wznowieniem).
...
Run: `cd backend && pytest -v` (całość zielona), potem `./scripts/smoke.sh http://<ip-nas>:8000 <user> <haslo>` na realnym NAS-ie.
